...
window.addEventListener("load", function(){
   ...
   var cartElems = document.forms.order.elements;
   cartElems.modelName.value = orderFields[3];
   cartElems.modelQty.value = orderFields[5];
   cartElems.orderCost.value = orderFields[7];
   cartElems.shippingType.value = orderFields[9];
   cartElems.shippingCost.value = orderFields[13];
   cartElems.subTotal.value = orderFields[15];
   cartElems.salesTax.value = orderFields[17];
   cartElems.cartTotal.value = orderFields[19];
});
...
function validateCredit() {
   ...
   console.log(creditCard.validity.valueMissing);
